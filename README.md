...
Доступ ко всем экранам приложения закрыт авторизацией.
Для входа в приложение клиенту нужно указать либо "хеш" камеры (ключ словаря "cameras"),
либо мастер-хеш ("master_cam_hash"), указанные в файле конфигурации, и ввести пароль.
Хеш пароля задаётся в переменных "cam_password_hash" и "master_password_hash" соответственно.

Для ведения журнала подключений на экране авторизации также нужно указать произвольное имя пользователя или псевдоним.
